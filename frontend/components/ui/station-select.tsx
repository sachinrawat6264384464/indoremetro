...
export function StationSelect({
  ...
  return (
    <div ref={containerRef} className={`relative w-full ${className}`}>
      ...
      {/* Floating Popover Dropdown Menu (Right-Aligned & High Z-Index) */}
      {isOpen && (
        <div className="absolute top-full right-0 min-w-full sm:min-w-[320px] max-w-[380px] mt-2 z-[100] bg-white rounded-2xl border border-slate-200 shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-150">
          {/* Search Bar */}
