...
export default function JourneyPlannerWidget() {
  ...
  return (
    <div className="w-full bg-white rounded-3xl p-5 sm:p-6 lg:p-7 border border-slate-200 shadow-xl space-y-4 relative">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 pb-3 border-b border-slate-100 relative z-10">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-2xl bg-amber-100 border border-amber-300 flex items-center justify-center shadow-sm shrink-0">
        ...
        <span className="px-3 py-1 rounded-full text-[11px] font-black bg-emerald-50 text-emerald-800 border border-emerald-300 flex items-center gap-1 shadow-sm shrink-0">
          <Sparkles className="w-3.5 h-3.5 text-emerald-600" /> Priority Corridor Active
        </span>
      </div>

      {/* Quick Select Chips */}
      <div className="flex flex-wrap items-center gap-1.5 relative z-10">
        <span className="text-[11px] font-extrabold text-slate-400 uppercase tracking-wider">Quick Select:</span>
        <button
          type="button"
      ...
      <form onSubmit={handlePlan} className="space-y-4 relative z-10">
        <div className="bg-slate-50/90 p-3.5 sm:p-4 rounded-2xl border border-slate-200 space-y-3 hover:border-amber-300 transition">
          ...
          <div className="relative flex justify-center py-0.5">
            ...
            <button
              type="button"
              onClick={handleSwap}
              className="relative z-10 px-3.5 py-1 rounded-full bg-amber-100 hover:bg-amber-500 text-amber-900 hover:text-slate-950 border border-amber-300 text-[11px] font-black flex items-center gap-1 shadow-sm transition transform hover:rotate-180 duration-300 cursor-pointer"
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full h-12 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-black text-sm flex items-center justify-center gap-2 shadow-md shadow-amber-500/25 transition transform hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-50"
        >
