  ...
  return (
    <div className="space-y-16 pb-20 bg-[#F8FAFC]">
      ...
      <section className="relative pt-4 lg:pt-6 w-full space-y-8 px-4 sm:px-6 lg:px-8">
        ...
        {/* Main Hero Card Container with Sharp Background */}
        <div className="bg-white rounded-3xl border border-slate-200 shadow-xl p-6 sm:p-8 lg:p-10 relative overflow-hidden group w-full">
          ...
          <div className="absolute inset-0 z-0">
            <Image
              ...
              fill
              priority
              className="object-cover object-right-bottom opacity-90 group-hover:scale-102 transition-transform duration-700 ease-out pointer-events-none"
            />
            {/* Soft gradient fade on left side for 100% crisp text readability without obscuring the train */}
            <div className="absolute inset-0 bg-gradient-to-r from-white via-white/85 via-40% to-transparent pointer-events-none" />
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center relative z-10">
            ...
            <div className="lg:col-span-7 space-y-5">
              ...
              <p className="text-sm sm:text-base text-slate-800 leading-relaxed font-bold max-w-xl">
              ...
              <div className="flex flex-wrap gap-3 pt-1">
                <Link
                  href="/journey"
                  className="px-5 py-3 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-black shadow-md shadow-amber-500/25 transition-all transform hover:-translate-y-0.5 flex items-center gap-2 text-sm"
                >
                  Plan Journey <ArrowRight className="w-4 h-4" />
                </Link>
                <Link
                  href="/book-ticket"
                  className="px-5 py-3 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-black shadow-md transition-all transform hover:-translate-y-0.5 flex items-center gap-2 text-sm"
                >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-4 border-t border-slate-200/80">
                <div className="bg-white/90 backdrop-blur-md p-3 rounded-2xl border border-slate-200/90 shadow-sm">
                  <span className="text-xl sm:text-2xl font-black text-slate-900 block font-mono">29</span>
                  <p className="text-[11px] text-slate-700 font-extrabold">Total Stations</p>
                </div>
                <div className="bg-white/90 backdrop-blur-md p-3 rounded-2xl border border-slate-200/90 shadow-sm">
                  <span className="text-xl sm:text-2xl font-black text-emerald-600 block font-mono">16</span>
                  <p className="text-[11px] text-slate-700 font-extrabold">Active Operational</p>
                </div>
                <div className="bg-white/90 backdrop-blur-md p-3 rounded-2xl border border-slate-200/90 shadow-sm">
                  <span className="text-xl sm:text-2xl font-black text-amber-600 block font-mono">31.46 km</span>
                  <p className="text-[11px] text-slate-700 font-extrabold">Yellow Line Loop</p>
                </div>
                <div className="bg-white/90 backdrop-blur-md p-3 rounded-2xl border border-slate-200/90 shadow-sm">
                  <span className="text-xl sm:text-2xl font-black text-sky-600 block font-mono">7 Mins</span>
                  <p className="text-[11px] text-slate-700 font-extrabold">Peak Frequency</p>
                </div>
              </div>
            </div>
